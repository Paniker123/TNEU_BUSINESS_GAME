...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20171204002017_Doba2")]
    partial class Doba2
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Common.Entity.GamePlayerEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Common.Entity.UserPlayerEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Common.Entity.PlayerForGameEntity", b =>
                {
                    ...
                    b.HasOne("Common.Entity.GamePlayerEntity", "Player")
                        .WithMany()
            ...
            modelBuilder.Entity("Common.Entity.UserPlayerEntity", b =>
                {
                    b.HasOne("Common.Entity.GamePlayerEntity", "GamePlayer")
                        .WithOne("UserPlayer")
                        .HasForeignKey("Common.Entity.UserPlayerEntity", "GamePlayerId")
                        .OnDelete(DeleteBehavior.Cascade);
